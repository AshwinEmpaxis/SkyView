...
// types
// Assuming DefaultRootStateProps['mail'] is an object with keys `error`, `mails`, and `unreadCount`
// If not, please replace DefaultRootStateProps['mail'] with the appropriate type
